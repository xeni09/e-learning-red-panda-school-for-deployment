...
import SectionsList from '../../components/courseComponents/SectionsList'; 
...
const CourseDetails = () => {
  ...
  // Función para editar una sección existente
  ...
  const handleDeleteSection = async (index) => {
    try {
      const updatedSections = sections.filter((_, i) => i !== index); // Eliminar la sección del array
      const updatedCourse = { ...courseData, sections: updatedSections };

      await axios.put(`/api/courses/${courseId}`, updatedCourse);

      setSections(updatedSections); // Actualizar el estado local
    } catch (error) {
