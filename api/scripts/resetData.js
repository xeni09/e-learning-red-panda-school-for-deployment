...
const testAdminData = {
  ...
  courses: [
    ...
    mongoose.Types.ObjectId("6719148235e3da83b8604cbe"),
    mongoose.Types.ObjectId(exampleCourseId),
  ],
};

const exampleCourseData = {
  _id: mongoose.Types.ObjectId(exampleCourseId),
  customId: 2,
  ...
  students: [
    ...
    mongoose.Types.ObjectId("67195e6ceb53edcb66acf378"),
  ],
  sections: [
    {
      _id: mongoose.Types.ObjectId("671926a198e9fa193411eaf8"),
    ...
    {
      _id: mongoose.Types.ObjectId("671926ba98e9fa193411eafc"),
    ...
    {
      _id: mongoose.Types.ObjectId("671926cb98e9fa193411eb01"),
    ...
    {
      _id: mongoose.Types.ObjectId("671926d798e9fa193411eb07"),
    ...
    {
      _id: mongoose.Types.ObjectId("67194472cb01580e368d5d38"),
